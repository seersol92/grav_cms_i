...
return [
    ...
    'filename' => 'D:/wamp64/www/project_i&i/user/plugins/admin/languages/fa.yaml',
    'modified' => 1712043151,
    'size' => 68466,
    'data' => [
        'PLUGIN_ADMIN' => [
...
با سپاس و احترام,<br /><br />%3$s</p>',
            ...
            'BACKUPS_PURGE_CONFIG' => 'پیکربندی پاکسازی نسخه‌های پشتیبان',
            'BACKUPS_PROFILES' => 'شناسه‌های پشتیبان',
            'BACKUPS_COUNT' => 'تعداد پشتیبان‌ها',
            'BACKUPS_PROFILES_COUNT' => 'تعداد شناسه‌ها',
            'BACKUPS_TOTAL_SIZE' => 'فضای استفاده شده',
            'BACKUPS_NEWEST' => 'جدیدترین نسخه پشتیبان',
            'BACKUPS_OLDEST' => 'قدیمی‌ترین نسخه پشتیبان',
            ...
            'BACKUPS_PURGE_TIME' => '%s روز از پشتیبان‌گیری گذشته است',
...
- https://michelf.ca/projects/php-markdown/extra',
            ...
            'JS_ASSETS' => 'فایل‌ها جاوا اسکریپت',
            ...
            'JS_MODULE_ASSETS' => 'ماژول فایل‌های جاوا اسکریپت',
            ...
            'GENERAL_CONFIG' => 'پیکربندی عمومی فایل‌ها',
            ...
            'ENABLED_SRI_ON_ASSETS' => 'فعالسازی SRI برای فایل‌ها',
            ...
            'LOG_HANDLER' => 'سیستم کنترل کننده رخ‌داد‌ها',
            'LOG_HANDLER_HELP' => 'محل خروجی رخ‌داده‌ها',
...
استفاده از حروف بزرگ ،فاصله ، و حروف خاص مجاز نمی باشد',
            ...
            'PROXY_CERT_HELP' => 'مسیر محلی به پوشه‌ی نگهدارنده فایل pem گواهی پروکسی',
