...
return [
    ...
    'filename' => 'D:/wamp64/www/project_i&i/user/plugins/admin/languages/fr.yaml',
    'modified' => 1712043151,
    'size' => 74401,
    'data' => [
        'PLUGIN_ADMIN' => [
            ...
            'MODAL_UPDATE_GRAV_CONFIRMATION_REQUIRED_DESC' => 'Vous êtes sur le point de mettre à jour Grav vers la dernière version disponible. Voulez-vous continuer ?',
            ...
            'SUPPORTED_PLACEHOLDER' => 'par exemple en, fr',
...
PLUGIN_ADMIN -> JAVASCRIPT_MODULE_PIPELINE_HELP',
            ...
            'FRONTMATTER_IGNORE_FIELDS_PLACEHOLDER' => 'par exemple : formulaires',
...
L\'**authentification à deux facteurs** est activée sur ce compte. Veuillez utiliser l\'application **A2F** pour entrer le **code à 6 chiffres** actuel afin de terminer le processus de connexion.',
            ...
            'ROUTE_OVERRIDES' => 'Remplacement du chemin',
            'ROUTE_DEFAULT' => 'Chemin par défaut',
            'ROUTE_CANONICAL' => 'Chemin canonique',
            'ROUTE_ALIASES' => 'Alias du chemin',
            ...
            'ACCESS_ADMIN_CONFIGURATION_SYSTEM' => 'Configuration du système',
            'ACCESS_ADMIN_CONFIGURATION_SITE' => 'Configuration du site',
            'ACCESS_ADMIN_CONFIGURATION_MEDIA' => 'Configuration du contenu',
            'ACCESS_ADMIN_CONFIGURATION_INFO' => 'Voir les informations du serveur',
            'ACCESS_ADMIN_SETTINGS' => 'Paramètres',
            'ACCESS_ADMIN_PAGES' => 'Gestion des pages',
            'ACCESS_ADMIN_MAINTENANCE' => 'Maintenance du site',
            'ACCESS_ADMIN_STATISTICS' => 'Statistiques',
            'ACCESS_ADMIN_PLUGINS' => 'Gestion des plugins',
            'ACCESS_ADMIN_THEMES' => 'Gestion des thèmes',
            'ACCESS_ADMIN_TOOLS' => 'Accès aux outils',
            ...
            'COLOR_SCHEME_LABEL' => 'Jeu de couleurs',
            'COLOR_SCHEME_HELP' => 'Choisissez un jeu de couleurs dans une liste de combinaisons prédéfinies, ou ajoutez votre propre style',
