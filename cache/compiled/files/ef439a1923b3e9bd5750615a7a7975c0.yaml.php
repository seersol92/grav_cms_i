...
return [
    ...
    'filename' => 'D:/wamp64/www/project_i&i/user/plugins/admin/languages/sw.yaml',
    'modified' => 1712043151,
    'size' => 60981,
    'data' => [
        'PLUGIN_ADMIN' => [
            'ADMIN_NOSCRIPT_MSG' => 'Tafadhali washa JavaScript kwenye kivinjari chako.',
            'ADMIN_BETA_MSG' => 'Hii ni toleo la Beta! Tumia hii katika uzalishaji kwa hatari yako mwenyewe ...',
            'ADMIN_REPORT_ISSUE' => 'Umepata shida? Tafadhali ripoti juu ya GitHub.',
            'LOGIN_BTN' => 'Ingia',
            'LOGIN_BTN_FORGOT' => 'Umesahau',
            'LOGIN_BTN_RESET' => 'Rudisha Nenosiri',
            'LOGIN_BTN_SEND_INSTRUCTIONS' => 'Tuma Maagizo ya Upya',
            'LOGIN_BTN_CLEAR' => 'Futa Fomu',
            'LOGIN_BTN_CREATE_USER' => 'Unda Mtumiaji',
            'LOGIN_LOGGED_IN' => 'Umeingia kwa mafanikio',
            'LOGIN_FAILED' => 'Kuingia hakujafaulu',
            'LOGGED_OUT' => 'Umetoka nje',
            'RESET_NEW_PASSWORD' => 'Tafadhali ingiza nywila mpya & hellip;',
            'RESET_LINK_EXPIRED' => 'Kiungo cha kuweka upya kimeisha muda, tafadhali jaribu tena',
            'RESET_PASSWORD_RESET' => 'Nenosiri limewekwa upya',
            'RESET_INVALID_LINK' => 'Kiungo batili cha kuweka upya kimetumika, tafadhali jaribu tena',
            'FORGOT_INSTRUCTIONS_SENT_VIA_EMAIL' => 'Maagizo ya kuweka upya nywila yako yametumwa kwa anwani yako ya barua pepe',
            'FORGOT_FAILED_TO_EMAIL' => 'Imeshindwa kutuma maagizo kwa barua pepe, tafadhali jaribu tena baadaye',
            'FORGOT_CANNOT_RESET_EMAIL_NO_EMAIL' => 'Haiwezi kuweka upya nywila ya% s, hakuna anwani ya barua pepe iliyowekwa',
            'FORGOT_USERNAME_DOES_NOT_EXIST' => 'Mtumiaji aliye na jina la mtumiaji <b>% s </b> hayupo',
            'FORGOT_EMAIL_NOT_CONFIGURED' => 'Haiwezi kuweka upya nenosiri. Tovuti hii haijasanidiwa kutuma barua pepe',
            'FORGOT_EMAIL_SUBJECT' => '% s Ombi la Kuweka Nenosiri',
            'FORGOT_EMAIL_BODY' => '<h1>Kuweka upya Nenosiri </h1><p>Mpendwa %1$s,</p> <p>Ombi lilitolewa kwenye <b>%4$s</b>kuweka upya nywila yako. </p><p><br /><a href="%2$s" class="btn-primary">Bonyeza hii kuweka upya nywila yako </a><br /><br /></p><p>Vinginevyo, nakili URL ifuatayo kwenye upau wa anwani ya kivinjari chako:</p> <p>%2$s</p><p><br />Kwa aina,<br /><br />%3$s</p>',
            'MANAGE_PAGES' => 'Dhibiti Kurasa',
            'PAGES' => 'Kurasa',
            ...
            'CONTINUE' => 'Endelea',
            'CONFIRM' => 'Thibitisha',
            'MODAL_DELETE_PAGE_CONFIRMATION_REQUIRED_TITLE' => 'Uthibitisho Unahitajika',
            'MODAL_CHANGED_DETECTED_TITLE' => 'Mabadiliko Yamegunduliwa',
            'MODAL_CHANGED_DETECTED_DESC' => 'Una mabadiliko ambayo hayajahifadhiwa. Je! Una uhakika unataka kuondoka bila kuhifadhi?',
            'MODAL_DELETE_FILE_CONFIRMATION_REQUIRED_TITLE' => 'Uthibitisho Unahitajika',
            'MODAL_DELETE_FILE_CONFIRMATION_REQUIRED_DESC' => 'Je! Una uhakika unataka kufuta faili hii? Kitendo hiki hakiwezi kutenduliwa.',
            'MODAL_UPDATE_GRAV_CONFIRMATION_REQUIRED_DESC' => 'Unakaribia kuboresha Grav kuwa toleo jipya zaidi. Je! Ungependa kuendelea?',
            'ADD_FILTERS' => 'Ongeza Vichujio',
            'SEARCH_PAGES' => 'Kurasa za Utafutaji',
            'VERSION' => 'Toleo',
            'WAS_MADE_WITH' => 'Ilitengenezwa na',
            'BY' => 'Na',
            'UPDATE_THEME' => 'Sasisha Mandhari',
            'UPDATE_PLUGIN' => 'Sasisha Programu-jalizi',
            'OF_THIS_THEME_IS_NOW_AVAILABLE' => 'ya mada hii sasa inapatikana',
            'OF_THIS_PLUGIN_IS_NOW_AVAILABLE' => 'ya programu-jalizi hii sasa inapatikana',
            'AUTHOR' => 'Mwandishi',
