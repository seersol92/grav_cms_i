...
return [
    ...
    'timestamp' => 1725372251,
    'checksum' => '5d3a7ffada3aeba4c17988bbcdc8ff04',
    'files' => [
        ...
        'user/themes' => [
            'themes/clean-blog' => [
                'file' => 'user/themes/clean-blog/blueprints.yaml',
                'modified' => 1712043147
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'plugins.form.basic_captcha.chars.box_width' => [
                'type' => 'number',
                ...
                'name' => 'plugins.form.basic_captcha.chars.box_width',
                'validation' => 'strict'
            ],
            'plugins.form.basic_captcha.chars.box_height' => [
                'type' => 'number',
                ...
                'name' => 'plugins.form.basic_captcha.chars.box_height',
                'validation' => 'strict'
            ],
            ...
            'themes.clean-blog.copyright' => [
                'type' => 'textarea',
                'label' => 'THEME_CLEAN_BLOG.ADMIN.COPYRIGHT.LABEL',
                'name' => 'themes.clean-blog.copyright',
                'validation' => 'loose'
            ],
            'themes.clean-blog.favicon' => [
                'type' => 'text',
                'label' => 'THEME_CLEAN_BLOG.ADMIN.FAVICON.LABEL',
                'name' => 'themes.clean-blog.favicon',
                'validation' => 'loose'
            ],
            'themes.clean-blog.default_header_image' => [
                'type' => 'text',
                'label' => 'THEME_CLEAN_BLOG.ADMIN.DEFAULT_HEADER_IMAGE.LABEL',
                'name' => 'themes.clean-blog.default_header_image',
                'validation' => 'loose'
            ],
            'themes.clean-blog.error_header_image' => [
                'type' => 'text',
                'label' => 'THEME_CLEAN_BLOG.ADMIN.ERROR_HEADER_IMAGE.LABEL',
                'name' => 'themes.clean-blog.error_header_image',
                'validation' => 'loose'
            ],
            'themes.clean-blog.social_icons' => [
                'array' => true,
                'type' => 'list',
                'label' => 'THEME_CLEAN_BLOG.ADMIN.SOCIAL_ICONS.LABEL',
                'name' => 'themes.clean-blog.social_icons',
                'validation' => 'loose'
            ],
            'themes.clean-blog.social_icons.*' => [
                'type' => '_parent',
            ...
            'themes.clean-blog.social_icons.*.icon' => [
                'type' => 'text',
                'label' => 'THEME_CLEAN_BLOG.ADMIN.SOCIAL_ICONS.FIELDS.ICON.LABEL',
                'name' => 'themes.clean-blog.social_icons.*.icon',
                'validation' => 'loose'
            ],
            'themes.clean-blog.social_icons.*.url' => [
                'type' => 'text',
                'label' => 'THEME_CLEAN_BLOG.ADMIN.SOCIAL_ICONS.FIELDS.URL.LABEL',
                'name' => 'themes.clean-blog.social_icons.*.url',
                'validation' => 'loose'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
                ...
                'form' => [
                    ...
                    'basic_captcha' => [
                        ...
                        'chars' => [
                            ...
                            'box_width' => 'plugins.form.basic_captcha.chars.box_width',
                            'box_height' => 'plugins.form.basic_captcha.chars.box_height'
                        ],
                        'math' => [
            ...
            'themes' => [
                'clean-blog' => [
                    'copyright' => 'themes.clean-blog.copyright',
                    'favicon' => 'themes.clean-blog.favicon',
                    'default_header_image' => 'themes.clean-blog.default_header_image',
                    'error_header_image' => 'themes.clean-blog.error_header_image',
                    'social_icons' => [
                        '*' => [
                            'icon' => 'themes.clean-blog.social_icons.*.icon',
                            'url' => 'themes.clean-blog.social_icons.*.url'
                        ]
                    ]
                ]
            ]
