...
class __TwigTemplate_a487de9a38c6cd79d5283cd8f66acb0aee20bbd6a8aeb5e8a49d6a61ecec60aa extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 6
        $context["can_export"] = (($context["can_export"]) ?? ($this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->boolFilter(((($this->getAttribute(($context["export"] ?? null), "enabled", [], "array", true, true) &&  !(null === $this->getAttribute(($context["export"] ?? null), "enabled", [], "array")))) ? ($this->getAttribute(($context["export"] ?? null), "enabled", [], "array")) : (count($this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->arrayFilter(($context["export"] ?? null))))))));
        // line 7
        ...
        // line 34
        $context["configure_route"] = (($context["configure_route"]) ?? (((($context["configure_path"] ?? null)) ? ($this->getAttribute(($context["route"] ?? null), "withRoute", [0 => twig_trim_filter($this->getAttribute($this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->adminRouteFunc(($context["configure_path"] ?? null)), "toString", [0 => true], "method"), "/")], "method")) : (null))));
        // line 35
        $context["configure_route"] = (($context["configure_route"]) ?? ($this->getAttribute($this->getAttribute(($context["route"] ?? null), "withGravParam", [0 => "", 1 => "configure"], "method"), "toString", [0 => true], "method")));
        // line 37
...
{% endif %}
{% endblock %}
", "flex-objects/types/default/list.html.twig", "D:\\wamp64\\www\\project_i&i\\user\\plugins\\flex-objects\\admin\\templates\\flex-objects\\types\\default\\list.html.twig");
    }
}
