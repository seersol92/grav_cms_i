...
class __TwigTemplate_7499c082b25d49196232c6d4a13b0d03272140520d5597f750254460d148c053 extends \Twig\Template
{
    ...
    <div class=\"form-data";
        ...
        if ( !($context["canOrder"] ?? null)) {
            ...
            echo $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_ADMIN.ORDERING_DISABLED_BECAUSE_PAGE_NO_PREFIX");
            echo "</div>
            ";
        }
        // line 41
        ...
        if ((twig_length_filter($this->env, ($context["siblings"] ?? null)) < 200)) {
            ...
            if ((($context["sortable_count"] ?? null) < twig_length_filter($this->env, ($context["siblings"] ?? null)))) {
                // line 53
                echo "                <label>";
                echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_ADMIN.UNSORTABLE_PAGES"), "html", null, true);
                echo "</label>
            ...
            // line 63
            echo "                <div class=\"notice\">";
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_ADMIN.ORDERING_DISABLED_BECAUSE_TOO_MANY_SIBLINGS"), "html", null, true);
            echo "</div>
            ";
        }
        // line 65
...
";
    ...
    {
        return array (  247 => 65,  241 => 63,  238 => 62,  234 => 60,  228 => 59,  218 => 57,  215 => 56,  211 => 55,  205 => 53,  203 => 52,  200 => 51,  186 => 50,  183 => 49,  181 => 48,  168 => 47,  165 => 46,  148 => 45,  143 => 44,  140 => 43,  138 => 42,  135 => 41,  129 => 39,  127 => 38,  121 => 36,  117 => 35,  109 => 30,  103 => 29,  96 => 26,  90 => 24,  82 => 22,  80 => 21,  73 => 19,  66 => 18,  63 => 17,  58 => 1,  56 => 15,  53 => 13,  51 => 12,  49 => 11,  45 => 8,  43 => 7,  41 => 6,  39 => 5,  37 => 4,  35 => 3,  29 => 1,);
    }
...
{% endblock %}
", "forms/fields/order/order.html.twig", "D:\\wamp64\\www\\project_i\\user\\plugins\\admin\\themes\\grav\\templates\\forms\\fields\\order\\order.html.twig");
    }
}
